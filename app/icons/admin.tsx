...
export const SettingIcon: Icon = ({ size = '24', ...attr }) => (
    <svg
        stroke='currentColor'
        fill='currentColor'
        strokeWidth='0'
...
export const CloudIcon: Icon = ({ size = '24', ...attr }) => (
    <svg
        xmlns='http://www.w3.org/2000/svg'
        viewBox='0 0 24 24'
        fill='none'
...
export const DashboardIcon: Icon = ({ size = '24', ...attr }) => (
    <svg
        stroke='currentColor'
        fill='currentColor'
        stroke-width='0'
...
export const NewContractIcon: Icon = ({ size = '24', ...attr }) => (
    <svg
        stroke='currentColor'
        fill='currentColor'
        stroke-width='0'
